...
func readMoreData(client:TCPClient, readData:[UInt8]?, lengthValue:Int, totalData:[UInt8], isFirst:Bool) -> [UInt8] {
    ...
    if recData != nil {
        //print("")
        //print("")
        //print("RecData Count: \(recData!.count)")
        //print("")
        //print("")
        let testString:String? = String(bytes: recData!, encoding: NSWindowsCP1250StringEncoding)
        if testString == nil {
            hadError = true
            //print("NIL: \(recData)")
//            if errorCount%2 == 1 {
