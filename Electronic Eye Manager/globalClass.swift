...
func getStrikes(success:Bool, errmsg:String, client:TCPClient, listingID: String, expDate:NSDate) -> String? {
    ...
    let sendStr:String = "{\"id\":1,\"target\":\"eye\",\"type\":\"request\",\"clientname\":\"perl\",\"payload\":{\"command\":\"get_atm_strikes\",\"rangesize\":15,\"securityid\":\(listingID),\"expdate\":\"\(expDateString)\",\"range_prev\":15,\"range_next\":15,\"fieldselection\":\(fieldSelection)}}"
...
func getMaturities(success:Bool, errmsg:String, client:TCPClient, listingID: String) {
    ...
    if success {
        ...
        if success1 {
            ...
            print("Maturities: FailedToSendData")
